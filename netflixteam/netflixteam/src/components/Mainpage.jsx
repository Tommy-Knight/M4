        ...
        return (
					<div>
						<div>
							...
							<div className="container ml-5 h4">
								TV Shows{" "}
							...
							<div className="container ml-5 my-5">
								<div className="row">
									<h5 className="d-none d-md-block">Trending Now</h5>
								</div>
								<h5 className="d-block d-md-none text-center">Trending Now</h5>
								<div className="row">
									<div className="col-12 col-md-4 col-lg-2 px-0">
										<div className="col text-center mb-3 mb-lg-0 px-1">
											<img
												className="img-fluid "
							...
							<div className="container  mb-5 ml-5">
								<div className="row">
									<h5 className="d-none d-md-block">Watch it again</h5>
								</div>
							...
							<div className="container">
								<div className="row">
									<h5 className="d-none d-md-block">New releases</h5>
								</div>
								<h5 className="d-block d-md-none text-center">New releases</h5>
								<div className="row">
									<div className="col-12 col-md-4 col-lg-2 px-0">
										<div className="col text-center mb-3 mb-lg-0 px-1">
											<img
